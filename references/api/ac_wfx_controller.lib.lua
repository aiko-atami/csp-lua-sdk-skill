...
---@return ac.WeatherType
function ac.getInputWeatherType() end

---@return ac.TemperatureParams
function ac.getInputTemperatures() end

---@return ac.WindParams
function ac.getInputWind() end

---@return ac.TrackConditions
function ac.getInputTrackState() end

---@param valuePresent boolean|refbool|nil|nil @Default value: `nil`.
---@return number
function ac.getInputHumidity(valuePresent) end

---@param valuePresent boolean|refbool|nil|nil @Default value: `nil`.
---@return number
function ac.getInputPressure(valuePresent) end

---Set current weather conditions. First version: rain wetness should get to 100% when rain starts, and water should
---try and get to rain intensity with a delay. 50% is for an average rain. Values will be automatically converted to
---follow the new system.
---@param c ac.ConditionsSet
function ac.setConditionsSet(c) end

---Set current weather conditions. Second version: rain wetness should match rain intensity (with a delay) and water
---only controls puddles amount and can be completely unrelated to other two rain values. 20% is for an average rain.
---@param c ac.ConditionsSet
function ac.setConditionsSet2(c) end
