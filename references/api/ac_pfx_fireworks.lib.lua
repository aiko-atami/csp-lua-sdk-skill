...
---@return vec3
function ac.getRandomFireworksSpot() end

---@param index integer
---@return vec3
function ac.getFireworksSpot(index) end

---@return integer
function ac.getFireworksSpotCount() end

---@param group integer
---@param pos vec3
---@param color rgb
---@param duration number
function ac.addFireworkFlash(group, pos, color, duration) end
...
--[[ pfx_fireworks/ac_fireworks.lua ]]

---@return ac.Firework
function ac.Firework() end
...
local _ac_Firework = nil

--[[ pfx_fireworks/ac_lists.lua ]]

---List of active ac.Firework. Use it to add or remove elements to the scene.
---@class ac.FireworksList : ac.GenericList
---@single-instance
ac.fireworks = nil

---@param index integer
---@return ac.Firework
function ac.fireworks:get(index) end
...
function ac.fireworks:set(index, item) end

---@param index integer
---@param item ac.Firework
function ac.fireworks:insert(index, item) end

---@param item ac.Firework
function ac.fireworks:push(item) end

---Inserts element to a first empty spot.
---@param item ac.Firework
function ac.fireworks:pushWhereFits(item) end

---Removes an element from the list (first occurance only).
---@param item ac.Firework
function ac.fireworks:erase(item) end

---Removes an element from a position, moves the rest one step forward to close the gap.
---@param index integer
---@return ac.Firework @Removed element.
function ac.fireworks:remove(index) end

---Removes the last element and returns it.
---@return ac.Firework
function ac.fireworks:pop() end

--[[ pfx_fireworks/ac_lists.lua ]]

---Adds a firework to the list of active fireworks.
---@param item ac.Firework
function ac.addFirework(item) end

---Removes a firework from the list of active fireworks.
---@param item ac.Firework
function ac.removeFirework(item) end
