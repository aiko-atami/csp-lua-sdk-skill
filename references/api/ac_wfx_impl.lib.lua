...
---@param value boolean? @Set to `true` to enable grass. Default value: `true`.
---@return ac.GeometryShot @Returns itself for chaining several methods together.
...
local _ac_PostProcessingParameters = nil
...
---@return number
function ac.getCurrentTime() end

---@return number
function ac.getDaySeconds() end

---@return integer
function ac.getDayOfTheYear() end

---@return number
function ac.getTimeMultiplier() end

---@return vec3
function ac.getSunDirection() end

---@param r vec3
function ac.getSunDirectionTo(r) end

---@return vec3
function ac.getMoonDirection() end

---@param r vec3
function ac.getMoonDirectionTo(r) end

---@return number
function ac.getSunAltitude() end

---@return vec2
function ac.getTrackCoordinates() end

---@return integer
function ac.getInputDate() end

---Can be used to compute eclipses reliably. Returns angle in radians, 0 for sun and moon angles being the same,
---`math.pi` if they are opposite. If real sun trajectory is disabled, returns `math.pi / 2`.
---@return number
function ac.getSunMoonAngle() end

---@param active boolean|`true`|`false`
function ac.setAsyncTextureLoading(active) end

---@param dir vec3
---@return rgb
function ac.getSkyAbsorption(dir) end

---@param v number
function ac.setBrightnessMult(v) end

---@param v number
function ac.setOverallSkyBrightnessMult(v) end
...
---
---Note: if post-processing disabled, you’d need to set it to 1 (unless there is a very specific case where it’d need a different value). Without
...
---@param v number? @Default value: 3.
function ac.setWhiteReferencePoint(v) end

---Sets brightness multiplier of Extra FX glowing emissive meshes.
---@param v number? @Default value: 1.
function ac.setTrueEmissiveMultiplier(v) end

---@param v number
function ac.setVAOExponent(v) end

---@param exponent number? @Default value: 0.7.
---@param from number? @Default value: 0.
---@param to number? @Default value: 1.
function ac.adjustTrackVAO(exponent, from, to) end

---@param exponent number? @Default value: 0.7.
---@param from number? @Default value: 0.
---@param to number? @Default value: 1.
function ac.adjustDynamicAOSamples(exponent, from, to) end

---@return vec2
function ac.getVAOMinMax() end

---@param v number
function ac.setTrackHeatFactor(v) end

---@param r rgb
---@param dir vec3
function ac.getSkyAbsorptionTo(r, dir) end

---@param dir vec3
---@return vec3
function ac.fixHeading(dir) end

---@param dir vec3
function ac.fixHeadingSelf(dir) end

---@param dir vec3
---@return vec3
function ac.fixHeadingInv(dir) end

---@param dir vec3
function ac.fixHeadingInvSelf(dir) end

---@param value ac.ShadowsState
function ac.setShadows(value) end

function ac.resetShadowsResolution() end

---@param value integer
function ac.setShadowsResolution(value) end

function ac.resetShadowsSplits() end

---@param interior vec3
---@param exterior vec3
function ac.setShadowsSplits(interior, exterior) end

---@param value ac.FogAlgorithm
function ac.setFogAlgorithm(value) end

---@param c rgb
function ac.setFogColor(c) end

---@param blend number
function ac.setFogBlend(blend) end

---@param distance number
function ac.setFogDistance(distance) end

---@param value number
function ac.setFogBacklitExponent(value) end

---@param value number
function ac.setFogBacklitMultiplier(value) end

---@param value number
function ac.setFogExponent(value) end

---@param value number
function ac.setFogHeight(value) end

---@param value number
function ac.setFogDensity(value) end

---@param value number
function ac.setFogAtmosphere(value) end

---Adds extra layer of particles. Currently, requires RainFX module to work. Doesn’t affect anything, purely a visual effect.
---@param kind 'snow'|'ash'
---@param value number @Intensity from 0 to 1.
---@param size number? @Particles size adjustment from 0 to 1. Default value: 0.
function ac.setWeatherParticles(kind, value, size) end

---Replaces falling raindrops with snowflakes. Doesn’t alter anything else at the moment, including windscreen raindrops.
---@param value number @Intensity from 0 to 1.
---@param size number? @Snowflake size adjustment from 0 to 1 (leave at -1 for an automatic value). Default value: -1.
function ac.setSnowMix(value, size) end

---Replaces falling raindrops with snowflakes. Doesn’t alter anything else at the moment, including windscreen raindrops.
---@param value number @Intensity from 0 to 1.
function ac.setRainWindscreenDropsMultiplier(value) end

---Adjusts GrassFX shading to avoid cartoonish flat look.
---@param specularity number
---@param reflectivity number
---@param backlit number? @Added in 0.2.8, default value is 0. Default value: 0.
---@param saturation number? @Added in 0.2.8, default value is 1. Default value: 1.
function ac.configureGrassShading(specularity, reflectivity, backlit, saturation) end

---@param color rgb
---@param distance number
---@param heightFactor number
---@param transparency number? @Default value: 1.
---@param exp number? @Default value: 1.
function ac.setNearbyFog(color, distance, heightFactor, transparency, exp) end

---@param dir vec3
function ac.setLightDirection(dir) end

---@param value number
function ac.setCameraExposure(value) end

---Extra exposure multiplier for automated exposure, to make things even more convoluted.
---@param value number
function ac.setCameraExposureMultiplier(value) end

---@param value boolean|`true`|`false`
function ac.setCarExposureActive(value) end

---@param c rgb
function ac.setLightColor(c) end

---@param value number
function ac.setLightShadowOpacity(value) end

---@return number
function ac.getCloudsShadow() end

---@return number
function ac.getCloudCoversShadow() end

---@param value boolean|`true`|`false`
function ac.setCloudShadowMaps(value) end

---@param value boolean|`true`|`false`
function ac.setCloudShadowIndependantOpacity(value) end

---Added in 0.3.0.
---@param amount number @0 to disable blur (a tiny amount would still be applied to prevent flicker, 1 for blurring of 0.2 builds.
---@param fadeWithDistance number? @-1 to disable fade out, 0 to disable to shadows where there is no data (recommended), 1 for fully shadowed distant clouds. Default value: -1.
function ac.setCloudShadowBlur(amount, fadeWithDistance) end

---@param value number
function ac.setCloudShadowDistance(value) end

---@param value number
function ac.setCloudShadowScalingFactor(value) end

---@param value number
function ac.setCloudArcMultiplier(value) end

---Use this function in case you’re calling `render.skyPass()` for custom sky shading.
---@param disable boolean? @Default value: `true`.
function ac.disableSkyRender(disable) end

---@param c rgb
function ac.setAmbientColor(c) end

---@param c rgb
---@param distance number
function ac.setDistantAmbientColor(c, distance) end

---@param c rgb
---@param exp number
function ac.setRadiosityAmbientColor(c, exp) end

---@param c rgb
function ac.setBaseAmbientColor(c) end

---@param c rgb
function ac.setExtraAmbientColor(c) end

---@param c vec3
function ac.setExtraAmbientDirection(c) end

---@param d number
function ac.setExtraAmbientDistance(d) end

---@param dir vec3
---@param color rgb
---@param earthRadius number? @Default value: 6371e3.
function ac.setCloudsLight(dir, color, earthRadius) end

function ac.resetCloudsLight() end

---@return boolean
function ac.isRainFxActive() end

---@return number
function ac.getRainAmount() end

---@param v number
function ac.setRainAmount(v) end

---@param v number
function ac.setRainWetness(v) end

---@param v number
function ac.setReflectionsBrightness(v) end

---@param v number
function ac.setReflectionsSaturation(v) end

---@param v number
function ac.setCameraOcclusionDepthBoost(v) end

---@param c rgb
function ac.setSunColor(c) end

---@param v string
---@param maxSize integer? @Default value: 0.
function ac.setSkyStarsMap(v, maxSize) end

---@param v string
---@param maxSize integer? @Default value: 0.
function ac.setSkyMoonTexture(v, maxSize) end

---@param v string
---@param maxSize integer? @Default value: 0.
function ac.setEarthTexture(v, maxSize) end

---@return ac.TextureState
function ac.getSkyStarsMapState() end

---@return ac.TextureState
function ac.getSkyMoonTextureState() end

---@return ac.TextureState
function ac.getEarthTextureState() end

---
---@deprecated.
---@param v string
function ac.unloadTexture(v) end

---@param c rgb
function ac.setSkyColor(c) end

---@param v number
function ac.setSkyAnisotropicIntensity(v) end

---@param v number
function ac.setSkyMultiScatterPhase(v) end

---@param v number
function ac.setSkyBrightnessMult(v) end

---@param v number
function ac.setSkySunMoonSizeMultiplier(v) end

---@param active boolean|`true`|`false`
function ac.setMoonEclipse(active) end

---@param v rgb
function ac.setSkyMoonBaseColor(v) end

---@param v number
function ac.setSkyMoonMieExp(v) end

---@param v number
function ac.setSkyMoonMieMultiplier(v) end

---@param v number
function ac.setSkyMoonBrightness(v) end

---@param v number
function ac.setSkyMoonOpacity(v) end

---@param v number
function ac.setSkyMoonGradient(v) end

---@param v number
function ac.setSkyMoonClipThreshold(v) end

---@param v boolean|`true`|`false`
function ac.setSkyMoonDepthSkip(v) end

---@param v rgb
function ac.setSkyStarsColor(v) end

---@param v number
function ac.setSkyStarsBrightness(v) end

---@param v number
function ac.setSkyStarsSaturation(v) end

---@param v number
function ac.setSkyStarsExponent(v) end

---@param v number
function ac.setSkyPlanetsBrightness(v) end

---@param v number
function ac.setSkyPlanetsOpacity(v) end

---@param v number
function ac.setSkyPlanetsSizeBase(v) end

---@param v number
function ac.setSkyPlanetsSizeVariance(v) end

---@param v number
function ac.setSkyPlanetsSizeMultiplier(v) end

---@param v boolean|`true`|`false`
function ac.setSkyUseV2(v) end

---@param v number
function ac.setSkyZenithOffset(v) end

---@param v number
function ac.setSkyZenithDensityExp(v) end

---@param v number
function ac.setSkyInputYOffset(v) end

---@param v number
function ac.setSkyDensity(v) end

---@param v rgb
function ac.setSkySunBaseColor(v) end

---@param v number
function ac.setSkySunBrightness(v) end

---@param v number
function ac.setSkySunMieExp(v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2RefractiveIndex(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2DepolarizationFactor(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2Luminance(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2MieCoefficient(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2MieDirectionalG(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2MieZenithLength(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2MieV(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2NumMolecules(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2Rayleigh(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2YOffset(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2YScale(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2RayleighZenithLength(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2SunIntensityFactor(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2SunIntensityFalloffSteepness(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2Turbidity(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2SunShapeMult(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2SunSaturation(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2BackgroundLight(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2Saturation(side, v) end

---@param side ac.SkyRegion
---@param v number
function ac.setSkyV2Gamma(side, v) end

---Doesn’t affect sky reflected from screen-space data. Ideally, try not to use it.
---@param luminance number? @Default value: 1.
---@param saturation number? @Default value: 1.
---@param gamma number? @Default value: 1.
function ac.setReflectedSkyTweaks(luminance, saturation, gamma) end

---@param side ac.SkyRegion
---@param v vec3
function ac.setSkyV2MieKCoefficient(side, v) end

---@param side ac.SkyRegion
---@param v vec3
function ac.setSkyV2Primaries(side, v) end

---@param v number
function ac.setSkyV2Rainbow(v) end

---@param v number
function ac.setSkyV2RainbowSecondary(v) end

---@param v number
function ac.setSkyV2RainbowDarkening(v) end

---@param v vec3
function ac.setSkyV2GradientDirection(v) end

function ac.resetSpecularColor() end

---@param c rgb
function ac.setSpecularColor(c) end

---@param value number
function ac.setSunSpecularMultiplier(value) end
...
---@param v number
function ac.setEmissiveMultiplier(v) end
...
---
---Multiplier `nearby` affects car interior materials and materials with explicit flag `ADAPTIVE_NEARBY_EMISSIVE`. Other value, `distant`,
...
---@param nearby number
---@param distant number
function ac.setAdaptiveEmissiveMultiplier(nearby, distant) end
...
---@param v number
function ac.setReflectionEmissiveBoost(v) end

---Resets emissives intensity boost in reflection cubemap.
function ac.resetReflectionEmissiveBoost() end

function ac.resetGlowBrightness() end

---@param v number
function ac.setGlowBrightness(v) end

function ac.resetGodraysCustomColor() end

---@param c rgb
function ac.setGodraysCustomColor(c) end

function ac.resetGodraysCustomDirection() end

---@param v vec3
function ac.setGodraysCustomDirection(v) end

---@param v number
function ac.setGodraysLength(v) end

---@param v number
function ac.setGodraysGlareRatio(v) end

---@param v number
function ac.setGodraysAngleAttenuation(v) end

---@param v number
function ac.setGodraysNoiseFrequency(v) end

---@param v number
function ac.setGodraysNoiseMask(v) end

---@param v number
function ac.setGodraysDepthMapThreshold(v) end

---@param v number
function ac.setGlareThreshold(v) end

---@param v number
function ac.setGlareBloomFilterThreshold(v) end

---@param v number
function ac.setGlareBloomLuminanceGamma(v) end

---@param v number
function ac.setGlareStarFilterThreshold(v) end

---@param v number
function ac.setPpColorTemperatureK(v) end

---@param v number
function ac.setPpWhiteBalanceK(v) end

---@param v number
function ac.setPpHue(v) end

---@param v number
function ac.setPpSepia(v) end

---@param v number
function ac.setPpSaturation(v) end

---@param v number
function ac.setPpBrightness(v) end

---@param v number
function ac.setPpContrast(v) end

---Does not do anything, added by mistake.
---@deprecated
---@param v boolean|`true`|`false`
function ac.resetPpValuesOnFilterChange(v) end

---@param v number
function ac.setLambertGamma(v) end

---@param v number
function ac.setFresnelGamma(v) end

---@param v number
function ac.setPpTonemapExposure(v) end

---@param v number
function ac.setPpTonemapGamma(v) end

---@param v boolean|`true`|`false`
function ac.setPpTonemapUseHdrSpace(v) end

---@param v number
function ac.setPpTonemapMappingFactor(v) end

---@param v number
function ac.setPpTonemapFilmicContrast(v) end

---@param v number
function ac.setPpColorGradingIntensity(v) end

---@param pause boolean? @Default value: `true`.
function ac.pauseCubemapUpdates(pause) end

---Used for cases where cheap HDR-to-LDR conversion is needed, for example, in extra car cameras.
---@param brightnessMult number @Applies to HDR image before exponent.
---@param exponent number
function ac.setHDRToLDRConversionHints(brightnessMult, exponent) end

---Switches AC rendering to using linear color space, fixing various rendering issues. Activates new fog with nearby
---fog layer as well, also changes behaviour of some WeatherFX style functions fixing multiple bugs.
---@param active boolean|`true`|`false`
---@param lightsDivisor number? @Used to scale lights to try and prevent clipping due to limited float16 precision. Default value: 1.
function ac.useLinearColorSpace(active, lightsDivisor) end

---@return boolean
function ac.isPpActive() end

---@return number
function ac.getGodraysLength() end

---@return number
function ac.getGodraysGlareRatio() end

---@return number
function ac.getGodraysAngleAttenuation() end

---@return number
function ac.getGodraysNoiseFrequency() end

---@return number
function ac.getGodraysNoiseMask() end

---@return number
function ac.getGodraysDepthMapThreshold() end

---@return number
function ac.getGlareThreshold() end

---@return number
function ac.getGlareBloomFilterThreshold() end

---@return number
function ac.getGlareStarFilterThreshold() end

---@return number
function ac.getPpColorTemperatureK() end

---@return number
function ac.getPpWhiteBalanceK() end

---@return number
function ac.getPpHue() end

---@return number
function ac.getPpSepia() end

---@return number
function ac.getPpSaturation() end

---@return number
function ac.getPpBrightness() end

---@return number
function ac.getPpContrast() end

---@return integer
function ac.getPpTonemapFunction() end

---@return number
function ac.getPpTonemapExposure() end

---@return number
function ac.getPpTonemapGamma() end

---@return number
function ac.getPpTonemapMappingFactor() end

---@return number
function ac.getPpTonemapFilmicContrast() end

---@return number
function ac.getPpTonemapUseHdrSpace() end

---@return boolean
function ac.getPpGodraysEnabled() end

---@return boolean
function ac.getPpDofEnabled() end

---@return boolean
function ac.getPpDofActive() end

---@return boolean
function ac.getPpChromaticAbberationActive() end

---@return boolean
function ac.getPpGlareGhostActive() end

---@return boolean
function ac.getPpHeatParticleActive() end

---@return boolean
function ac.getPpAirydiskEnabled() end

---@return boolean
function ac.getPpAntialiasingEnabled() end

---@return boolean
function ac.getPpAutoExposureEnabled() end

---@return boolean
function ac.getPpChromaticAbberationEnabled() end

---@return boolean
function ac.getPpFeedbackEnabled() end

---@return boolean
function ac.getPpLensDistortionEnabled() end

---@return boolean
function ac.getPpHeatParticleEnabled() end

---@return boolean
function ac.getPpGlareEnabled() end

---@return boolean
function ac.getPpGlareAnamorphicEnabled() end

---@param v number|vec2
function ac.setPpTonemapViewportScale(v) end

---@param v number|vec2
function ac.setPpTonemapViewportOffset(v) end

---@param v boolean|`true`|`false`
function ac.setHeatParticles(v) end

---@return boolean
function ac.isVertexAoPatchApplied() end

---@return boolean
function ac.isTrackAmbientLowerMultiplierDefined() end

---@return number
function ac.getTrackAmbientLowerMultiplier() end

---@return ac.LightPollution
function ac.getTrackLightPollution() end

---@return number
function ac.getWeatherStaticAmbientLowerMultiplier() end

---@param lower rgb
---@param higher rgb
function ac.setWeatherStaticAmbient(lower, higher) end

function ac.resetWeatherStaticAmbient() end

---@param direct number
---@param mirror number
function ac.setEmissiveCameraGain(direct, mirror) end

---@param value number
function ac.setExtraAsphaltReflectionsMultiplier(value) end
...
---@param active boolean|`true`|`false`
function ac.setCloudsSorting(active) end

function ac.sortClouds() end

---@param material ac.ParticlesMaterial
function ac.setParticlesSmokeMaterial(material) end

---@param material ac.ParticlesMaterial
function ac.setParticlesGrassMaterial(material) end

---@param material ac.ParticlesMaterial
function ac.setParticlesGrassPiecesMaterial(material) end

---@param v number
function ac.setWeatherFakeShadowOpacity(v) end

---@param v number
function ac.setWeatherFakeShadowConcentrarion(v) end

---@param v number
function ac.setWeatherFakeShadowConcentration(v) end

---@param v number
function ac.setWeatherDynamicAmbientMultiplier(v) end

---@param v number
function ac.setWeatherDynamicAmbientSaturation(v) end

---@param v number
function ac.setWeatherDynamicAmbientGamma(v) end

---@param v number
function ac.setWeatherDynamicAmbientBrightness(v) end

---@param v rgb
function ac.setWeatherBouncedLightMultiplier(v) end

---@param v rgb
function ac.setWeatherBouncedInteriorLightMultiplier(v) end

---@param v vec3
function ac.setWeatherBouncedLightShDirection(v) end

---@param v number
function ac.setWeatherBouncedLightShMultiplier(v) end

---@param v number
function ac.setWeatherBouncedLightShSaturation(v) end

---@return number
function ac.getWeatherLightsMultiplier() end

---@param value number
function ac.setWeatherLightsMultiplier(value) end

---@param value number
function ac.setWeatherLightsRangeFactor(value) end

---@param value number
function ac.setWeatherTrackLightsMultiplierThreshold(value) end

function ac.resetWeatherLightsMultiplier() end

---Unlike `ac.setWeatherLightsMultiplier()`, this one won’t interfere with dim lights deactivation thresholds. Available only with gamma fix applied.
---@param value number
function ac.setWeatherLightsMultiplier2(value) end

---@return number
function ac.getAutoExposure() end

---@param v boolean|`true`|`false`
function ac.setAutoExposureActive(v) end

---@param v boolean|`true`|`false`
function ac.setAutoExposureInfluencedByGlare(v) end

---@param v number
function ac.setAutoExposureTarget(v) end

---@param center number|vec2
---@param size number|vec2
function ac.setAutoExposureMeasuringArea(center, size) end

---@param min number
---@param max number
function ac.setAutoExposureLimits(min, max) end

---Changes shader used for resolving MSAA depth buffer to one using minimum (nearest) sample. By default the opposite (furthest) is used.
---@param v boolean|`true`|`false`
function ac.useMinDepthResolution(v) end

---@param v number
function ac.setSkyFogMultiplier(v) end

---@param horizon number
---@param exp number
---@param rangeMult number
function ac.setHorizonFogMultiplier(horizon, exp, rangeMult) end

function ac.resetHorizonFogMultiplier() end

---@param v vec3
---@return number
function ac.calculateSkyFog(v) end

---@param value boolean|`true`|`false`
function ac.fixSkyColorCalculateOrder(value) end

---@param value boolean|`true`|`false`
function ac.fixSkyColorCalculateResult(value) end

---@param value boolean|`true`|`false`
function ac.fixSkyV2Fog(value) end

---@param scale number
function ac.setSkyV2DitherScale(scale) end

---@param value boolean|`true`|`false`
function ac.fixCloudsV2Fog(value) end

---@param v vec3
---@param radius number
---@param applyFixHeading boolean? @Default value: `true`.
---@return boolean
function ac.testFrustumIntersection(v, radius, applyFixHeading) end

---@param v vec3
---@param includeSun boolean|`true`|`false`
---@param includeMoonColor boolean|`true`|`false`
---@param includeSunMie boolean? @Default value: `true`.
---@return rgb
function ac.calculateSkyColor(v, includeSun, includeMoonColor, includeSunMie) end
...
---@param includeMoonColor boolean|`true`|`false`
---@param includeSunMie boolean? @Default value: `true`.
function ac.calculateSkyColorTo(r, v, includeSun, includeMoonColor, includeSunMie) end
...
---@param includeSunMie boolean? @Default value: `true`.
---@return rgb
function ac.calculateSkyColorV2(v, includeSun, includeMoonColor, includeSunMie) end
...
---@param includeMoonColor boolean|`true`|`false`
---@param includeSunMie boolean? @Default value: `true`.
function ac.calculateSkyColorV2To(r, v, includeSun, includeMoonColor, includeSunMie) end
...
---@param includeSunMie boolean? @Default value: `true`.
---@return rgb
function ac.calculateSkyColorNoGradients(v, includeSun, includeMoonColor, includeSunMie) end
...
---@param includeMoonColor boolean|`true`|`false`
---@param includeSunMie boolean? @Default value: `true`.
function ac.calculateSkyColorNoGradientsTo(r, v, includeSun, includeMoonColor, includeSunMie) end

---@param v vec3
---@return rgb
function ac.sampleSH(v) end

---@param r rgb
---@param v vec3
function ac.sampleSHTo(r, v) end

---@return number
function ac.sampleCameraAO() end

---@param look vec3
---@return number
function ac.getCameraOcclusion(look) end

---@return number
function ac.getCameraLookOcclusion() end

---@return boolean
function ac.isBouncedLightActive() end

---@param settings ac.SkyCloudMapParams
function ac.generateCloudMap(settings) end

---@param value boolean|`true`|`false`
function ac.setManualCloudsInvalidation(value) end

function ac.invalidateCloudMaps() end

function ac.invalidateCloudReflections() end

---@param value number
function ac.adjustCubemapReprojectionBrightness(value) end

---Note: `track`, `cloudShadows` and `sceneEnd` callbacks are only called with main pass ID.
---@param sky render.PassID? @Default value: `render.PassID.None`.
---@param clouds render.PassID? @Default value: `render.PassID.None`.
---@param track render.PassID? @Default value: `render.PassID.None`.
---@param cloudShadows render.PassID? @Default value: `render.PassID.None`.
---@param sceneEnd render.PassID? @Default value: `render.PassID.None`.
function ac.enableRenderCallback(sky, clouds, track, cloudShadows, sceneEnd) end

---To be used from `ac.onPostProcessing()` callback if you want to sync with color adjustments.
---@return mat4x4
function ac.getPostProcessingHDRColorMatrix() end

---To be used from `ac.onPostProcessing()` callback if you want to sync with color adjustments. If not accessed and YEBIS is replaced,
---LDR color matrix will be applied automatically to the final output.
---@return mat4x4
function ac.getPostProcessingLDRColorMatrix() end

---To be used from `ac.onPostProcessing()` callback if you want to sync with color grading. Use `dynamic::pp::colorGrading3D` as texture name to use it properly.
---@return number @Returns 0 if color grading is disabled or failed to load.
function ac.getPostProcessingColorGradingIntensity() end

---Use this function to suggest AIs to turn headlights on or off. Different AIs will switch on different values to keep things varied.
---For example, first AI will activate headlights with `v` above 0.2 and second AI with `v` above 0.8. Also affects player headlights
---if automatically switching headlights are active (threshold for player is always 0.5).
---
--- Lights can’t change more than once per second.
---@param v number
---@param vaoThreshold number? @Lights would also activate if car VAO is below this value. Default value: 0.
function ac.setAiHeadlightsSuggestion(v, vaoThreshold) end

---Use `ac.setAiHeadlightsSuggestion()` instead.
---@deprecated
---@param v boolean|`true`|`false`
function ac.setAiHeadlights(v) end
...
---@param zoom number? @Set above 0 and below 1 to zoom in (1 zooms in a single point in front of camera), set below 0 to expand region taken into account. You might need to get camera FOV with `ac.getSim().cameraFOV` to calculate optimal zoom value for your case. Default value: 0.
---@param yExp number? @Controls alternative 360° estimation. Increase to see more ground. You can see a preview of base texture with ReflectionFX Debug App. Default value: 0.25.
---@param yMult number? @Controls alternative 360° estimation. Increase to see more ground. You can see a preview of base texture with ReflectionFX Debug App. Default value: 1.5.
---@return boolean @Returns `false` if it couldn’t activate estimation (for example, if ReflectionsFX module is disabled).
function ac.useCubemapBrightnessEstimation(zoom, yExp, yMult) end
...
---@return number @Returns maximum brightness, or -1 if it’s not yet available (hasn’t been computed yet, or if ReflectionsFX is disabled).
function ac.getCubemapBrightnessEstimationMaximum() end
...
---- Cubemap reduces emissive values for certain highly emissive meshes, such as lampposts, in certain cases (for example, to stop lampposts close to camera ruining lighting for the whole scene).
---- Update happens once every two frames, and has a delay for about ten frames (which is inevitable with how GPUs work, delay so high is to make sure it would never cause a lock and a corresponding FPS drop)
---@return number @Returns minimum brightness, or -1 if it’s not yet available (hasn’t been computed yet, or if ReflectionsFX is disabled).
function ac.getCubemapBrightnessEstimationMinimum() end
...
---- Cubemap reduces emissive values for certain highly emissive meshes, such as lampposts, in certain cases (for example, to stop lampposts close to camera ruining lighting for the whole scene).
---- Update happens once every two frames, and has a delay for about ten frames (which is inevitable with how GPUs work, delay so high is to make sure it would never cause a lock and a corresponding FPS drop)
---@return number @Returns average brightness, or -1 if it’s not yet available (hasn’t been computed yet, or if ReflectionsFX is disabled).
function ac.getCubemapBrightnessEstimationAverage() end
...
---- Update happens once every two frames, and has a delay for about ten frames (which is inevitable with how GPUs work, delay so high is to make sure it would never cause a lock and a corresponding FPS drop)
---@return number @Returns maximum brightness, or -1 if it’s not yet available (hasn’t been computed yet, or if ReflectionsFX is disabled).
function ac.getCubemap360BrightnessEstimationMaximum() end
...
---- Update happens once every two frames, and has a delay for about ten frames (which is inevitable with how GPUs work, delay so high is to make sure it would never cause a lock and a corresponding FPS drop)
---@return number @Returns minimum brightness, or -1 if it’s not yet available (hasn’t been computed yet, or if ReflectionsFX is disabled).
function ac.getCubemap360BrightnessEstimationMinimum() end
...
---- Update happens once every two frames, and has a delay for about ten frames (which is inevitable with how GPUs work, delay so high is to make sure it would never cause a lock and a corresponding FPS drop)
---@return number @Returns average brightness, or -1 if it’s not yet available (hasn’t been computed yet, or if ReflectionsFX is disabled).
function ac.getCubemap360BrightnessEstimationAverage() end

---Draw a simple tornado at a given point. Implementation might change in the future.
---@param pos vec3
---@param scale number
---@param alpha number
---@param time number
function render.tornado(pos, scale, alpha, time) end
...
---Override function used to draw virtual mirrors. If set, virtual mirrors will be drawn after the scene and the HDR→LDR post-processing conversion, fixing
---some issues with scriptable filters, sunrays and other visual effects. Please keep this function fast.
---
---Shader receives an HDR color and is expected to return LDR color. Example:
---```
---float4 main(float4 hdrCol, float2 uv) {
---  // HDR texture is accessible as `txInput`
---  return pow(hdrCol, 0.4545);
---}
---```
---@param v {values: table, defines: table, shader: string, cacheKey: integer}? @Pass `nil` to disable override.
function ac.overrideVirtualMirrorShader(v) end
...
---@param filename string
function _ac_SkyCloudBase:setTexture(filename) end
...
---@return ac.TextureState
function _ac_SkyCloudBase:getTextureState() end
...
---@param filename string
function _ac_SkyCloud:setNoiseTexture(filename) end
...
---@return ac.TextureState
function _ac_SkyCloud:getNoiseTextureState() end
...
local _ac_SkyCloudMaterial = nil
...
function ac.SkyCloudMapParams() end
...
local _ac_SkyCloudMapParams = nil

---@return ac.SkyCloudMapParams
function ac.SkyCloudMapParams.new() end

--[[ wfx_impl/ac_cloudscovers.lua ]]

---Special cloud-like thing for drawing 360° cloud textures.
---@return ac.SkyCloudsCover
function ac.SkyCloudsCover() end
...
function _ac_SkyCloudsCover:setTexture(filename, maxSize) end

function _ac_SkyCloudsCover:getTextureState() end

---@param filename string
---@param maxSize number? @If non-zero, sets a maximum size for MIPs to load. Any MIPs larger than that will be skipped. Only works with BC6H/BC7 compression, or with DXT1/3/5/RGBA8888 if using new loader option is enabled.
function _ac_SkyCloudsCover:setMaskTexture(filename, maxSize) end

function _ac_SkyCloudsCover:getMaskTextureState() end

function _ac_SkyCloudsCover:setFogParams(fogHorizon, fogZenith, fogExponent, fogRangeMult) end

--[[ wfx_impl/ac_gradients.lua ]]

---@param t { direction: vec3, sizeFull: number, sizeStart: number, isAdditive: boolean, isIncludedInCalculate: boolean, color: rgb, exponent: number }? 
---@return ac.SkyExtraGradient
function ac.SkyExtraGradient(t) end
...
local _ac_SkyExtraGradient = nil

--[[ wfx_impl/ac_particlematerials.lua ]]

---@param emissiveBlend number 
---@param diffuse number 
---@param ambient number 
---@return ac.ParticlesMaterial
function ac.ParticlesMaterial(emissiveBlend, diffuse, ambient) end

---@class ac.ParticlesMaterial
---@field emissiveBlend number
---@field diffuse number
---@field ambient number
local _ac_ParticlesMaterial = nil

--[[ wfx_impl/ac_lightpollution.lua ]]
...
---@return ac.LightPollution
function ac.LightPollution(position, radius, tint, density) end
...
local _ac_LightPollution = nil

--[[ wfx_impl/ac_obsolete.lua ]]
...
---@deprecated
function ac.setSkyExtraGradient(id, gradient) end

---@deprecated
ac.addSkyExtraGradients = ac.addSkyExtraGradient

--[[ wfx_impl/ac_lists.lua ]]

---List of active ac.SkyCloudBase. Use it to add or remove elements to the scene.
---@class ac.WeatherCloudsList : ac.GenericList
---@single-instance
ac.weatherClouds = nil

---@param index integer
---@return ac.SkyCloudBase
function ac.weatherClouds:get(index) end

---If item is null, element will be removed from said position, moving rest one step forward to close the gap.
---@param index integer
---@param item ac.SkyCloudBase
function ac.weatherClouds:set(index, item) end

---@param index integer
---@param item ac.SkyCloudBase
function ac.weatherClouds:insert(index, item) end

---@param item ac.SkyCloudBase
function ac.weatherClouds:push(item) end

---Inserts element to a first empty spot.
---@param item ac.SkyCloudBase
function ac.weatherClouds:pushWhereFits(item) end

---Removes an element from the list (first occurance only).
---@param item ac.SkyCloudBase
function ac.weatherClouds:erase(item) end

---Removes an element from a position, moves the rest one step forward to close the gap.
---@param index integer
---@return ac.SkyCloudBase @Removed element.
function ac.weatherClouds:remove(index) end

---Removes the last element and returns it.
---@return ac.SkyCloudBase
function ac.weatherClouds:pop() end

---List of active ac.SkyCloudsCover. Use it to add or remove elements to the scene.
---@class ac.WeatherCloudsCoversList : ac.GenericList
---@single-instance
ac.weatherCloudsCovers = nil

---@param index integer
---@return ac.SkyCloudsCover
function ac.weatherCloudsCovers:get(index) end

---If item is null, element will be removed from said position, moving rest one step forward to close the gap.
---@param index integer
---@param item ac.SkyCloudsCover
function ac.weatherCloudsCovers:set(index, item) end

---@param index integer
---@param item ac.SkyCloudsCover
function ac.weatherCloudsCovers:insert(index, item) end

---@param item ac.SkyCloudsCover
function ac.weatherCloudsCovers:push(item) end

---Inserts element to a first empty spot.
---@param item ac.SkyCloudsCover
function ac.weatherCloudsCovers:pushWhereFits(item) end

---Removes an element from the list (first occurance only).
---@param item ac.SkyCloudsCover
function ac.weatherCloudsCovers:erase(item) end

---Removes an element from a position, moves the rest one step forward to close the gap.
---@param index integer
---@return ac.SkyCloudsCover @Removed element.
function ac.weatherCloudsCovers:remove(index) end

---Removes the last element and returns it.
---@return ac.SkyCloudsCover
function ac.weatherCloudsCovers:pop() end

---List of active ac.SkyExtraGradient. Use it to add or remove elements to the scene.
---@class ac.SkyExtraGradientsList : ac.GenericList
---@single-instance
ac.skyExtraGradients = nil

---@param index integer
---@return ac.SkyExtraGradient
function ac.skyExtraGradients:get(index) end

---If item is null, element will be removed from said position, moving rest one step forward to close the gap.
---@param index integer
---@param item ac.SkyExtraGradient
function ac.skyExtraGradients:set(index, item) end

---@param index integer
---@param item ac.SkyExtraGradient
function ac.skyExtraGradients:insert(index, item) end

---@param item ac.SkyExtraGradient
function ac.skyExtraGradients:push(item) end

---Inserts element to a first empty spot.
---@param item ac.SkyExtraGradient
function ac.skyExtraGradients:pushWhereFits(item) end

---Removes an element from the list (first occurance only).
---@param item ac.SkyExtraGradient
function ac.skyExtraGradients:erase(item) end

---Removes an element from a position, moves the rest one step forward to close the gap.
---@param index integer
---@return ac.SkyExtraGradient @Removed element.
function ac.skyExtraGradients:remove(index) end

---Removes the last element and returns it.
---@return ac.SkyExtraGradient
function ac.skyExtraGradients:pop() end

---List of active ac.ColorCorrectionBase. Use it to add or remove elements to the scene.
---@class ac.WeatherColorCorrectionsList : ac.GenericList
---@single-instance
ac.weatherColorCorrections = nil

---@param index integer
---@return ac.ColorCorrectionBase
function ac.weatherColorCorrections:get(index) end

---If item is null, element will be removed from said position, moving rest one step forward to close the gap.
---@param index integer
---@param item ac.ColorCorrectionBase
function ac.weatherColorCorrections:set(index, item) end

---@param index integer
---@param item ac.ColorCorrectionBase
function ac.weatherColorCorrections:insert(index, item) end

---@param item ac.ColorCorrectionBase
function ac.weatherColorCorrections:push(item) end

---Inserts element to a first empty spot.
---@param item ac.ColorCorrectionBase
function ac.weatherColorCorrections:pushWhereFits(item) end

---Removes an element from the list (first occurance only).
---@param item ac.ColorCorrectionBase
function ac.weatherColorCorrections:erase(item) end

---Removes an element from a position, moves the rest one step forward to close the gap.
---@param index integer
---@return ac.ColorCorrectionBase @Removed element.
function ac.weatherColorCorrections:remove(index) end

---Removes the last element and returns it.
---@return ac.ColorCorrectionBase
function ac.weatherColorCorrections:pop() end

--[[ wfx_impl/ac_customtonemapping.lua ]]
...
function ac.setPpTonemapFunction(v) end

--[[ wfx_impl/ac_postprocessing.lua ]]
...
---@return ac.Disposable
function ac.onPostProcessing(callback) end
