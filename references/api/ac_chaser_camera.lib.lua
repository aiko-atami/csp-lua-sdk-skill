...
---@return vec3
function ac.getCarPosition() end

---@return vec3
function ac.getCarDirection() end

---@return vec3
function ac.getCarUp() end

---@return vec3
function ac.getCarVelocity() end

---@return vec3
function ac.getCarAngularVelocity() end

---@return vec3
function ac.getCarLocalVelocity() end

---@return vec3
function ac.getCarLocalAngularVelocity() end

---@return vec3
function ac.getCarGForces() end

---@return boolean
function ac.isGearGrinding() end

---@return number
function ac.getTurboBoost() end

---@return number
function ac.getEngineLifeLeft() end

---@return number
function ac.getCGHeight() end

---@param tyre integer
---@return number
function ac.getTyreSlip(tyre) end

---@param tyre integer
---@return number
function ac.getTyreSlipRatio(tyre) end

---@param tyre integer
---@return number
function ac.getTyreSlipAngle(tyre) end

---@param tyre integer
---@return number
function ac.getTyreAngularSpeed(tyre) end

---@param tyre integer
---@return vec3
function ac.getTyreContactPoint(tyre) end

---@param tyre integer
---@return vec3
function ac.getTyrePosition(tyre) end

---@param tyre integer
---@return vec3
function ac.getTyreDirection(tyre) end

---@param side integer
---@return number
function ac.getDamageLevel(side) end

---@return number
function ac.getSteer() end

---@return number
function ac.getGas() end

---@return number
function ac.getBrake() end

---@return number
function ac.getClutch() end

---@return integer
function ac.getGear() end

---@return boolean
function ac.looksLeft() end

---@return boolean
function ac.looksRight() end

---@return boolean
function ac.looksBehind() end
...
function ac.getCameraParameters(index) end

---@return vec2
function ac.getJoystickLook() end

---@class ScriptData
---@field update fun(dt: number) @Called each frame. Param `dt` is time since the last call of `.update()` in seconds.
---@field onCarChanged fun() @Called when selected car changes mid-run (won’t be called at the start). By the time it’s called, `car` has already been updated.
---@single-instance
script = {}
